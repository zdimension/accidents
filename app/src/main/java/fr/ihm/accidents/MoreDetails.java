    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(this.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY)) {
            photoButton.setOnClickListener(v -> {
                if(ContextCompat.checkSelfPermission(MoreDetails.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(MoreDetails.this, new String[]{Manifest.permission.CAMERA}, REQUEST_IMAGE_PERMISSION);
                    return;
                }
                ...
                try {
                    ...
                    Toast.makeText(MoreDetails.this, "Erreur lors de la creation du chemin", Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
            });
        } else
