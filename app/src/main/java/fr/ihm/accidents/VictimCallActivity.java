...
public class VictimCallActivity extends AppCompatActivity implements LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonInfosToGive = findViewById(R.id.infosToGiveToggle);
        infosToGiveText = findViewById(R.id.infosToGiveText);
        ...
        toggleButtonFirstAidGestures = findViewById(R.id.firsttAidGesturesToggle);
        firstAidGesturesImg = findViewById(R.id.firsttAidGesturesPng);
