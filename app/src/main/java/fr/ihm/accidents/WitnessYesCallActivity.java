...
public class WitnessYesCallActivity extends AppCompatActivity implements LocationListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toggleButtonInfosToGive = findViewById(R.id.infosToGiveToggleWitnessYesCall);
        infosToGiveText = findViewById(R.id.infosToGiveTextWitnessYesCall);
        ...
        toggleButtonFirstAidGestures =
            findViewById(R.id.firsttAidGesturesToggleWitnessYesCall);
        firstAidGesturesImg = findViewById(R.id.firsttAidGesturesPngWitnessYesCall);
